      ...
      <a-col :lg="11" :md="10" :sm="9">
        <div class="right-wrapper">
          <div class="detected-img" :hidden="hiddenDetectedImg">
            <a-divider orientation="left">车牌检测结果</a-divider>
          ...
          <div class="ocr-text" :hidden="hiddenOcrText">
            <a-divider orientation="left">识别的车牌</a-divider>
          ...
          for (let i = 0; i < raw_data.length; i++) {
            ...
            if (i < raw_data.length - 1) {
              ...
              if (
                ...
                _this.$data.ocrText += raw_data[i][0] + ' '
              } else {
                _this.$data.ocrText += raw_data[i][0] + '\r'
              }
            } else {
              _this.$data.ocrText += raw_data[i][0]
            }
